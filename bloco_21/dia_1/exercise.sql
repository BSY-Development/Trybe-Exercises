...
SELECT JOB_ID, AVG(SALARY) FROM employees GROUP BY JOB_ID ORDER BY SALARY DESC;
...
SELECT JOB_ID, SUM(SALARY) FROM employees WHERE JOB_ID = 'IT_PROG' GROUP BY JOB_ID;
